                    ...
                    <div class="col-lg-5 col-md-4 col-12">
                        ...
                        <div class="single-footer f-about">
                            <ul class="social small" >
	                                <li><a href="#" style="padding:10px;"><i class="lni lni-facebook-filled" ></i></a></li>
	                                <li><a href="#" style="padding:10px;"><i class="lni lni-twitter-original"></i></a></li>
	                                <li><a href="#" style="padding:10px;"><i class="lni lni-instagram"></i></a></li>
	                                <li><a href="#" style="padding:10px;" ><i class="lni lni-linkedin-original"></i></a></li>
	                                <li><a href="#" style="padding:10px;" ><i class="lni lni-youtube" ></i></a></li>
	                       </ul>
                            <div class="logo">
                                <a href="Home.do">
